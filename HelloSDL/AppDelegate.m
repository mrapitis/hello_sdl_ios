...
#warning TODO : Replace these constants with your app's name and assigned ID
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [proxyManager startProxyWithConfiguration:[SDLLifecycleConfiguration defaultConfigurationWithAppName:@"HelloSDL" appId:@"8675309"]];
    ...
    //    HSDLManager *manager = [HSDLManager sharedManager];
